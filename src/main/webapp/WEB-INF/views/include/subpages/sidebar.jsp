...
<!-- SIDE BAR -->
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-left ms-3" data-color="success" id="sidenav-main" style="background:white;">
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link active" href="${path}/board/list">
          ...
          <span class="nav-link-text ms-1">전체 게시글</span>
        </a>
      </li>
